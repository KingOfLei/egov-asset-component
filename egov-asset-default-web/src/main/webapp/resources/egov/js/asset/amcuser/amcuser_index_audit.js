...
define([ "app/widgets/window/app-dialog", "app/app-pagebase",
		 "resources/egov/js/asset/amcuser/amcuser_modify.js","resources/egov/js/asset/amcuser/amcuser_resetpassword.js"],
			...
			var AmcUserAuditModel = PageBase.extend({
						// 类初始化
						initialize : function() {
							AmcUserAuditModel.superclass.initialize.call(this);
						},
						...
						listeners : {
							...
							amcUserPanelUserdetails:{
								onDblClickRow:function(rowData, rowIndex){
									var self = AmcUserAuditModel.getInstance();
									...
									/*modify.showUserInfo({toDoStatus:modify.ACTION.EDIT,userCode:userCode},function(){
										AmcUserAuditModel.getInstance().refreshData();
									});*/
						...
						doDeleteData : function(data, e) {
							var _self = AmcUserAuditModel.getInstance();
			...
			AmcUserAuditModel.getInstance = function() {
				if (!this.instance) {
					this.instance = new AmcUserAuditModel();
				}
				return this.instance;
			}

			return AmcUserAuditModel.getInstance();
		})