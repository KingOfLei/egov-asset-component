        ...
        <div id="outerContainer">
            <div id="sidebarContainer">
                <div id="toolbarSidebar">
                    <div class="splitToolbarButton toggled">
                        <button class="toolbarButton group toggled" data-l10n-id="thumbs" id="viewThumbnail" tabindex="2" title="Show Thumbnails">
                            <span data-l10n-id="thumbs_label">
                                Thumbnails
                            </span>
                        </button>
                        <button class="toolbarButton group" data-l10n-id="outline" id="viewOutline" tabindex="3" title="Show Document Outline">
                            <span data-l10n-id="outline_label">
                                Document Outline
                            </span>
                        </button>
                        <button class="toolbarButton group" data-l10n-id="attachments" id="viewAttachments" tabindex="4" title="Show Attachments">
            ...
            <div id="mainContainer">
                <div class="findbar hidden doorHanger hiddenSmallView" id="findbar">
                    <label class="toolbarLabel" data-l10n-id="find_label" for="findInput">
                        Find:
                    </label>
                    <input class="toolbarField" id="findInput" tabindex="91">
                        <div class="splitToolbarButton">
                            <button class="toolbarButton findPrevious" data-l10n-id="find_previous" id="findPrevious" tabindex="92" title="">
                        ...
                        <input class="toolbarField" id="findHighlightAll" type="checkbox">
                            <label class="toolbarLabel" data-l10n-id="find_highlight" for="findHighlightAll" tabindex="94">
                                Highlight all
                            </label>
                            <input class="toolbarField" id="findMatchCase" type="checkbox">
                                <label class="toolbarLabel" data-l10n-id="find_match_case_label" for="findMatchCase" tabindex="95">
                                    Match case
                                </label>
                                <span class="toolbarLabel" id="findMsg">
                                </span>
                            </input>
                        </input>
                    </input>
                ...
                <div class="secondaryToolbar hidden doorHangerRight" id="secondaryToolbar">
                    <div id="secondaryToolbarButtonContainer">
                        ...
                        <button class="secondaryToolbarButton handTool" data-l10n-id="hand_tool_enable" id="toggleHandTool" tabindex="60" title="Enable hand tool">
                        ...
                        <button class="secondaryToolbarButton documentProperties" data-l10n-id="document_properties" id="documentProperties" tabindex="61" title="Document Properties…">
                    ...
                    <div id="toolbarContainer">
                        <div id="toolbarViewer">
                            <div id="toolbarViewerLeft">
                                ...
                                <button class="toolbarButton group hiddenSmallView" data-l10n-id="findbar" id="viewFind" tabindex="12" title="Find in Document">
                                ...
                                <label class="toolbarLabel" data-l10n-id="page_label" for="pageNumber" id="pageNumberLabel">
                                    Page:
                                </label>
                                <input class="toolbarField pageNumber" id="pageNumber" min="1" size="4" tabindex="15" type="number" value="1">
                                    <span class="toolbarLabel" id="numPages">
                                    </span>
                                </input>
                            </div>
                            <div id="toolbarViewerRight">
                                ...
                                <%--<button class="toolbarButton openFile hiddenLargeView" data-l10n-id="open_file" id="openFile" tabindex="32" title="Open File">--%>
                                    ...
                                    <%--</span>--%>
                                <%--</button>--%>
                                <button class="toolbarButton print hiddenMediumView" style="display:none;" data-l10n-id="print" id="print" tabindex="33" title="Print">
                                    <span data-l10n-id="print_label">
                                        Print
                                    </span>
                                </button>
                                <button class="toolbarButton download hiddenMediumView" style="display:none;" data-l10n-id="download" id="download" tabindex="34" title="Download">
                                    <span data-l10n-id="download_label">
                                        Download
                                    </span>
                                </button>
                                <a class="toolbarButton bookmark hiddenSmallView" style="display:none;" data-l10n-id="bookmark" href="#" id="viewBookmark" tabindex="35" title="Current view (copy or open in new window)">
                                    <span data-l10n-id="bookmark_label">
                                        Current View
                                    </span>
                                </a>
                                ...
                                <div class="innerCenter" id="toolbarViewerMiddle">
                                    ...
                                    <span class="dropdownToolbarButton" id="scaleSelectContainer">
                                        <select data-l10n-id="zoom" id="scaleSelect" tabindex="23" title="Zoom">
                                            <option data-l10n-id="page_scale_auto" id="pageAutoOption" selected="selected" title="" value="auto">
                                                Automatic Zoom
                                            </option>
                                            <option data-l10n-id="page_scale_actual" id="pageActualOption" title="" value="page-actual">
                                                Actual Size
                                            </option>
                                            <option data-l10n-id="page_scale_fit" id="pageFitOption" title="" value="page-fit">
                                                Fit Page
                                            </option>
                                            <option data-l10n-id="page_scale_width" id="pageWidthOption" title="" value="page-width">
                                                Full Width
                                            </option>
                                            <option id="customScaleOption" title="" value="custom">
                                            </option>
                                            <option data-l10n-args='{ "scale": 50 }' data-l10n-id="page_scale_percent" title="" value="0.5">
                                                50%
                                            </option>
                                            <option data-l10n-args='{ "scale": 75 }' data-l10n-id="page_scale_percent" title="" value="0.75">
                                                75%
                                            </option>
                                            <option data-l10n-args='{ "scale": 100 }' data-l10n-id="page_scale_percent" title="" value="1">
                                                100%
                                            </option>
                                            <option data-l10n-args='{ "scale": 125 }' data-l10n-id="page_scale_percent" title="" value="1.25">
                                                125%
                                            </option>
                                            <option data-l10n-args='{ "scale": 150 }' data-l10n-id="page_scale_percent" title="" value="1.5">
                                                150%
                                            </option>
                                            <option data-l10n-args='{ "scale": 200 }' data-l10n-id="page_scale_percent" title="" value="2">
                                                200%
                                            </option>
                                            <option data-l10n-args='{ "scale": 300 }' data-l10n-id="page_scale_percent" title="" value="3">
                                                300%
                                            </option>
                                            <option data-l10n-args='{ "scale": 400 }' data-l10n-id="page_scale_percent" title="" value="4">
                                                400%
                                            </option>
                                        </select>
                                    </span>
                ...
                <div hidden="true" id="errorWrapper">
                    ...
                    <textarea hidden="true" id="errorMoreInfo" readonly="readonly">
                    </textarea>
                </div>
            </div>
            <!-- mainContainer -->
            <div class="hidden" id="overlayContainer">
                <div class="container hidden" id="passwordOverlay">
                    <div class="dialog">
                        <div class="row">
                            <p data-l10n-id="password_label" id="passwordText">
                        ...
                        <div class="buttonRow">
                            <button class="overlayButton" id="passwordCancel">
                                <span data-l10n-id="password_cancel">
                                    Cancel
                                </span>
                            </button>
                            <button class="overlayButton" id="passwordSubmit">
                ...
                <div class="container hidden" id="documentPropertiesOverlay">
                    <div class="dialog">
                        ...
                        <div class="buttonRow">
                            <button class="overlayButton" id="documentPropertiesClose">
