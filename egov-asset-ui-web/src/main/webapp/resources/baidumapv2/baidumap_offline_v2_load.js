...
var bdmapcfg = {
  ...
  'tiles_dir':'http://192.168.56.88:8280/egov-asset-map-web/tiles/'   //瓦片图的目录，为空默认在 baidumap_v2/tiles/ 目录
};
...
bdmapcfg.home = "http://192.168.56.88:8280/egov-asset-map-web/resources/baidumapv2/"; //地图API主目录, images,tiles都在此目录下
(function(){
