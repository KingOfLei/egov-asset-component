...
import com.bosssoft.egov.asset.common.util.PropUtils;
/**
...
public class FileManager implements Config {
    ...
    private static final String CONFIG_NAME = "fastdfsConfig";
    ...
    private static void initFastDFSClient() throws MyException {
        ...
        ClientGlobal.g_connect_timeout = PropUtils.getInt(CONFIG_NAME,"fastDFS.connect_timeout",
        ...
        ClientGlobal.g_network_timeout = PropUtils.getInt(CONFIG_NAME,"fastDFS.network_timeout",
        ...
        ClientGlobal.g_charset = PropUtils.getString(CONFIG_NAME,"fastDFS.charset");
        if (ClientGlobal.g_charset == null || ClientGlobal.g_charset.length() == 0) {
            ClientGlobal.g_charset = "ISO8859-1";
        }

        szTrackerServers = PropUtils.getString(CONFIG_NAME,"fastDFS.tracker_server").split(",");
        ...
        ClientGlobal.g_tracker_http_port = PropUtils.getInt(CONFIG_NAME,"fastDFS.http.tracker_http_port", 80);
        ClientGlobal.g_anti_steal_token = PropUtils.getBoolean(CONFIG_NAME,"fastDFS.http.anti_steal_token", false);
        if (ClientGlobal.g_anti_steal_token) {
            ClientGlobal.g_secret_key = PropUtils.getString(CONFIG_NAME,"fastDFS.http.secret_key");
        }
    }
