...
public interface AssetActivitiConfigMapper extends Mapper<AssetActivitiConfig>{
...
/**
	 ...
	 * @param searcher 查询条件
	 * @param pageable 分页信息
	 * @return AssetActivitiConfigPage列表
	 * @throws BusinessException 自定义异常
	 *
	 */
	public Page<AssetActivitiConfig> queryAssetActivitiConfigPage(@Param("searcher")Searcher searcher,@Param("page")Page<AssetActivitiConfig> page);
