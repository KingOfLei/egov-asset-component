package com.bosssoft.egov.asset.activiti.modeler.rest.diagram.services;
	...
	public ObjectNode getDiagramNode(String processInstanceId, String processDefinitionId) {
		...
		if (processInstanceId != null) {
			...
			if (processInstance == null) {
				throw new BusinessException("Process instance could not be found");
			}
		...
		if (processDefinitionId == null) {
			throw new BusinessException("No process definition id provided");
		}
